...
class _OwnerHomePageState extends State<OwnerHomePage> {
  ...
  Widget _header() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          const Text("Espace Propriétaire",
  ...
  Widget _statsSection() {
    return Transform.translate(
      ...
      child: Row(
        ...
        children: [
          _statCard("1", "Salles", Icons.apartment),
          _statCard("2", "Réservations", Icons.calendar_month),
          _statCard("350k", "Revenus", Icons.trending_up),
        ],
      ),
    );
  }
  ...
  Widget _reservationList() {
    return Column(
      children: [
        _reservationCard("Marie Dubois", "+237 677889900",
            "mercredi 15 janvier 2025", "350000 FCFA", true),
        const SizedBox(height: 12),
        _reservationCard("Paul Kamga", "+237 655443322",
            "lundi 20 janvier 2025", "350000 FCFA", false),
      ],
    );
  }

  Widget _reservationCard(String name, String phone, String date, String price,
      bool pending) {
    return Container(
